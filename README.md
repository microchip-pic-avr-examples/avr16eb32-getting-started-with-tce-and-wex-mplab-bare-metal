...
* [<strong>Generate PWM Signals Using TCE:</strong>](TCE_DS_4PWM_Signals) In this use case, the TCE is initialized in Dual Slope Mode to generate four Pulse-Width Modulation (PWM) signals with different duty cycles, scaling and high resolution option.
